                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" class="form-control input-sm" maxlength="70" placeholder="Nome do Pai">
                                </div>
                                ...
                                <div class="form-group col-sm-4">
                                    <label>Idade</label>
                                    <input type="text" class="form-control input-sm" maxlength="10" placeholder="Idade do paciente">
                                </div>                              
                                <div class="form-group col-sm-4">
